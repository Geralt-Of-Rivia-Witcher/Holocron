<p align="center">
  ...
  <p align="center">
    <h3 align="center">The Frontend code of Holocron</h3>
    <p align="center" >
...
This is the frontend code of Holocron.
...
2. Install NPM packages
   ...
   npm install
   ```
3. If you have your backend deployed on a cloud service like "Heroku", etc, then create a `.env` file and paste your backend URL in it.
   ```JS
   BACKEND_URL = 'YOUR BACKEND URL'
   ```
   otherwise, React will make `API` requests at "http://localhost:5000/" for currency conversion feature.
